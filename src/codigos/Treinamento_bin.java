...
public class Treinamento_bin {
	...
	public static void comecar_treinamento(int qtd_epocas) throws IOException, InterruptedException {
        ...
        ListBuilder b1 = new NeuralNetConfiguration.Builder()
                ...
                .updater(new Sgd(taxa_aprendizado))
                .biasInit(-1)
	...
	private static void treinamento(MultiLayerNetwork model, int nEpochs, String nome_rede, ArrayList<ArrayList<Double[]>> dados) throws IOException, InterruptedException {
        ...
        rrTest.initialize(new FileSplit(new File(diretorio_dataset,"normalizado_bin_validacao_tb_amostras_final_201908251648.csv")));
        DataSetIterator testIter = new RecordReaderDataSetIterator(rrTest,batchSize,4,2);
        
        RecordReader rr = new CSVRecordReader(1, ',');
        rr.initialize(new FileSplit(new File(diretorio_dataset,"normalizado_bin_treinamento_tb_amostras_final_201908251648.csv")));
        DataSetIterator trainIter = new RecordReaderDataSetIterator(rr,batchSize,4,2);
