...
public class Saida5Classificada {
    ...
    public static void main(String[] args) throws Exception {
	    ...
	    if(modo == ModoExecucao.COMECAR) {
	    	...
	    	Treinamento.comecar_treinamento(1000);		// treinará por 5000 épocas
	
	    } else if (modo == ModoExecucao.CONTINUAR) {
	    	
	    	Treinamento.continuar_treinamento("20191001_2342", 40000); // continuará o treinamento do arquivo por 500 épocas
